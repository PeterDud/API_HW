...
Важливо: даний проект використовує API заблокованого в Україні сайту vk.com, тому щоб додаток працював коректно, необхідно 
користуватись VPN (TunnelBear, CyberGhost etc.).
